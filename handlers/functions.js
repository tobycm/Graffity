module.exports = {
    ...
    duration: function(ms) {
        ...
        return `\`${days} Ngày\`,\`${hrs} Giờ\`,\`${min} Phút\`,\`${sec} Giây\``;
    },
    ...
    format: function(millis) {
      try{
        ...
        if (h < 1) return (m < 10 ? "0" : "") + m + ":" + (s < 10 ? "0" : "") + s + " | " + (Math.floor(millis / 1000)) + " Giây";
        else return (h < 10 ? "0" : "") + h + ":" + (m < 10 ? "0" : "") + m + ":" + (s < 10 ? "0" : "") + s + " | " + (Math.floor(millis / 1000)) + " Giây";
      }catch (e){
        console.log(String(e.stack).bgRed)
      }
    },
